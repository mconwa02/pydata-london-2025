...
class PPOTrainAlgorithm(BaseRLAlgorithm):
    ...
    def __init__(
            ...
            rl_problem_title: str = configs.RL_ALGO_TRADER_ENV_NAME,
            ...
            is_action_space_discrete: bool = configs.IS_PROBLEM_SPACE_DISCRETE,
            train_total_time_steps: int = configs.SB3_TRAIN_TOTAL_TIMESTEPS,
    ):
        """
        Constructor
        ...
        :param is_action_space_discrete:
        :param train_total_time_steps:
        """
    ...
    def non_tuned_hyperparameters(self) -> Dict[str, Any]:
        ...
        if self._is_action_space_discrete:
             hyper_parameters_ = hyper_parameters.pop("use_sde")
        return hyper_parameters_
