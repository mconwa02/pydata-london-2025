...
class BaseRLAlgorithm(ABC):
    ...
    def __init__(
        ...
        self._train_total_time_steps = train_total_time_steps
    ...
    @property
    def smoothed_average_rewards(self) -> List[float]:
        """
        Getter for the smoothed average rewards
        :return: Smoothed average rewards
        """
        results_monitor_path = f"{configs.LOG_FOLDER}/{self._rl_problem_title}_{self._rl_algo_type.name}/monitor.csv"
