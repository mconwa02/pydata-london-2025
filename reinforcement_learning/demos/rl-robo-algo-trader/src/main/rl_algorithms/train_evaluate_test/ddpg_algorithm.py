...
class DDPGTrainAlgorithm(BaseRLAlgorithm):
    ...
    def __init__(
            self,
            env: gym.Env,
            rl_algorithm_type: RLAgorithmType = RLAgorithmType.ddpg,
    ...
    def train(self):
        ...
        self._model.learn(total_timesteps=self._train_total_time_steps, callback=[callback, eval_callback])
    ...
    def tuned_hyper_parameters(self) -> Dict[str, Any]:
        ...
        noise_type = best_hyper_parameters_all.get(configs.HYPER_PARAMETER_NOISE_TYPE)
        noise_std = best_hyper_parameters_all.get(configs.HYPER_PARAMETER_NOISE_STD)
        ...
        filter_list = [configs.HYPER_PARAMETER_NOISE_TYPE, configs.HYPER_PARAMETER_NOISE_STD,
                       configs.HYPER_PARAMETER_NET_ARCH, configs.HYPER_PARAMETER_ACTIVATION_FN]
