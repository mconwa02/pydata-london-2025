...
class DQNTrainAlgorithmTest(ut.TestCase):
    ...
    def setUp(self):
        ...
        self.env_name = configs.RL_ALGO_TRADER_ENV_NAME
    ...
    def test_DQNTrainAlgorithm_Constructor_Is_Valid(self):
        ...
        dqn_agent = DQNTrainAlgorithm(env=self.env, rl_algorithm_type=self.rl_algorithm_type)
